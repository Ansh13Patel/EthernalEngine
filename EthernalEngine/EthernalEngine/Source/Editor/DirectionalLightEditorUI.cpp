...
namespace EthernalEngine
{
	void DirectionalLightEditorUI::ShowDirectionalLightParameters(DirectionalLight* dirLight)
	{
		...
		ImGui::SameLine();
		ImGui::DragFloat("##AmbientStrength", &dirLight->ambientStrength, 0.0f, 1.0f);

		ImGui::Text("Specular Strength");
		ImGui::SameLine();
		ImGui::DragFloat("##SpecularStrength", &dirLight->specularStrength, 0.0f, 1.0f);

		ImGui::Text("Intensity");
		ImGui::SameLine();
		ImGui::DragFloat("##Intensity", &dirLight->intensity, 0.1f, 5.0f);
